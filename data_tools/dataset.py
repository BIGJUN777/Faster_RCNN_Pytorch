...
class Dataset:
    def __init__(self, args):
        self.args = args
        self.db = VOCBboxDataset(args.voc_data_dir)
...
class TestDataset:
    def __init__(self, args, split='test', use_difficult=True):
        self.args = args
        self.db = VOCBboxDataset(args.voc_data_dir, split=split, use_difficult=use_difficult)
